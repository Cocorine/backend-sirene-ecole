...
class AuthService implements AuthServiceInterface
{
     ...
     */
    public function requestOtp(string $telephone): array
    {
        try {
     ...
     */
    public function verifyOtpAndLogin(string $telephone, string $otp): array
    {
        try {
            // Vérifier l'OTP
     ...
     */
    public function login(string $identifiant, string $motDePasse): array
    {
        try {
